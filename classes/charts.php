...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("users" == $this->chrt_array['tables'][0])
			return true;
		if("user_types" == $this->chrt_array['tables'][0])
			return true;
		if("user_jobs" == $this->chrt_array['tables'][0])
			return true;
		if("user_details" == $this->chrt_array['tables'][0])
			return true;
		if("findme web_audit" == $this->chrt_array['tables'][0])
			return true;
		if("find_me_ids" == $this->chrt_array['tables'][0])
			return true;
		if("verification_ids" == $this->chrt_array['tables'][0])
			return true;
		if("find_me_jobs" == $this->chrt_array['tables'][0])
			return true;
		...
		if("districts" == $this->chrt_array['tables'][0])
			return true;
		if("towns" == $this->chrt_array['tables'][0])
			return true;
		if("polling_stations" == $this->chrt_array['tables'][0])
			return true;
		if("polling_coordinates_picture" == $this->chrt_array['tables'][0])
			return true;
		if("polling_coordinates_map" == $this->chrt_array['tables'][0])
			return true;
		if("polling_coordinates_info" == $this->chrt_array['tables'][0])
			return true;
		if("polling_coordinates_contact" == $this->chrt_array['tables'][0])
			return true;
		if("polling_coordinates" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
