...
function GetTableURL($table = "")
{
	...
	if("user_details" == $table) 
		return "user_details";
	if("findme web_audit" == $table) 
		return "findme_web_audit";
	if("find_me_ids" == $table) 
		return "find_me_ids";
	if("verification_ids" == $table) 
		return "verification_ids";
	if("find_me_jobs" == $table) 
		return "find_me_jobs";
	if("job_categories" == $table) 
	...
	if("towns" == $table) 
		return "towns";
	if("polling_stations" == $table) 
		return "polling_stations";
	if("polling_coordinates_picture" == $table) 
		return "polling_coordinates_picture";
	if("polling_coordinates_map" == $table) 
		return "polling_coordinates_map";
	if("polling_coordinates_info" == $table) 
		return "polling_coordinates_info";
	if("polling_coordinates_contact" == $table) 
		return "polling_coordinates_contact";
	if("polling_coordinates" == $table) 
		return "polling_coordinates";
...
{	
	...
	if("users" == $shortTName) 
		return "users";
	if("user_types" == $shortTName) 
		return "user_types";
	if("user_jobs" == $shortTName) 
		return "user_jobs";
	if("user_details" == $shortTName) 
		return "user_details";
	if("findme_web_audit" == $shortTName) 
		return "findme web_audit";
	if("find_me_ids" == $shortTName) 
		return "find_me_ids";
	if("verification_ids" == $shortTName) 
		return "verification_ids";
	if("find_me_jobs" == $shortTName) 
		return "find_me_jobs";
	...
	if("towns" == $shortTName) 
		return "towns";
	if("polling_stations" == $shortTName) 
		return "polling_stations";
	if("polling_coordinates_picture" == $shortTName) 
		return "polling_coordinates_picture";
	if("polling_coordinates_map" == $shortTName) 
		return "polling_coordinates_map";
	if("polling_coordinates_info" == $shortTName) 
		return "polling_coordinates_info";
	if("polling_coordinates_contact" == $shortTName) 
		return "polling_coordinates_contact";
	if("polling_coordinates" == $shortTName) 
		return "polling_coordinates";
}
