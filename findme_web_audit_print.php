...
require_once("include/findme_web_audit_variables.php");
...
$page_layouts["findme_web_audit_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "findme web_audit" );
