...
function getCaptionTable($table)
{
	...
	if($table=="polling_coordinates_picture")
	{
		return "Polling Coordinates Picture";
	}
	if($table=="polling_coordinates_map")
	{
		return "Polling Coordinates Map";
	}
	if($table=="polling_coordinates_info")
	{
		return "Polling Coordinates Info";
	}
	if($table=="polling_coordinates_contact")
	{
		return "Polling Coordinates Contact";
	}
	if($table=="polling_coordinates")
	{
		return "Polling Coordinates";
	}
	return $table;
}
...
function GetTablesListReport()
{
	...
	if($securityFlag)
	{
		$value="polling_coordinates_picture";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="polling_coordinates_info";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="polling_coordinates_contact";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
