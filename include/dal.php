...
class tDAL
{
	...
	var $find_me_ids;
	var $find_me_jobs;
	var $findme_web_audit;
	var $job_categories;
	var $polling_coordinates;
	var $polling_coordinates_contact;
	var $polling_coordinates_info;
	var $polling_coordinates_map;
	var $polling_coordinates_picture;
	var $polling_stations;
	var $regions;
	var $towns;
	var $user_details;
	var $user_jobs;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "countries", "varname" => "countries", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "districts", "varname" => "districts", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "find_me_ids", "varname" => "find_me_ids", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "find_me_jobs", "varname" => "find_me_jobs", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "findme web_audit", "varname" => "findme_web_audit", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "job_categories", "varname" => "job_categories", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "polling_coordinates", "varname" => "polling_coordinates", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "polling_coordinates_contact", "varname" => "polling_coordinates_contact", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "polling_coordinates_info", "varname" => "polling_coordinates_info", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "polling_coordinates_map", "varname" => "polling_coordinates_map", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "polling_coordinates_picture", "varname" => "polling_coordinates_picture", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "polling_stations", "varname" => "polling_stations", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "regions", "varname" => "regions", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "towns", "varname" => "towns", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "user_details", "varname" => "user_details", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "user_jobs", "varname" => "user_jobs", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "user_types", "varname" => "user_types", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "users", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "verification_ids", "varname" => "verification_ids", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "webreport_admin", "varname" => "webreport_admin", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "webreport_style", "varname" => "webreport_style", "connId" => "findme_db_at_localhost");
		$this->lstTables[] = array("name" => "webreports", "varname" => "webreports", "connId" => "findme_db_at_localhost");
	}
