...
require_once("include/user_details_variables.php");
...
$page_layouts["user_details_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "user_details" );
