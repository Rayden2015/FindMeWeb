...
require_once("include/verification_ids_variables.php");
...
$page_layouts["verification_ids_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "verification_ids" );
